    ...
    <main className="pt-16">
      ...
      <section className="px-5 py-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl">
          <h1 className="font-display text-5xl uppercase leading-none text-text sm:text-6xl">Java Full Stack Developer Skills</h1>
          <p className="mt-5 max-w-3xl text-lg leading-8 text-muted">
            Technical skills across React, JavaScript, Java, Spring Boot, SQL, REST APIs, Git, GitHub, and web
