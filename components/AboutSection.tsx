      ...
      <div className="grid items-start gap-6 lg:grid-cols-[1.05fr_0.95fr]">
        <div className="border border-line bg-surface p-5 shadow-clean sm:p-6">
          <p className="text-base leading-8 text-muted sm:text-lg">
            I am Muhammad Sufiyan, a Java Full Stack Developer focused on building practical web applications with Java,
            Spring Boot, React, JavaScript, REST APIs, SQL databases, and responsive frontend interfaces. I also publish
            work as mdsufidev.
          </p>
          {!compact ? (
            <p className="mt-5 text-base leading-8 text-muted sm:text-lg">
              FileWalaTool is one of my real projects, built around useful PDF, image, and document tools. This
              portfolio also includes MangaLok and a React Resume Builder.
            </p>
          ) : null}
