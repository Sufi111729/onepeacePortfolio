...
import wallpaper from '../assets/onepiece-wallpaper.png';
...
export default function Hero() {
  ...
  return (
    ...
    >
      <motion.div
        aria-hidden="true"
        style={{ backgroundImage: `url(${wallpaper})`, y }}
        className="hero-wallpaper-bg"
      />
      <div className="absolute inset-0 bg-[linear-gradient(90deg,#070707_0%,rgba(7,7,7,0.94)_34%,rgba(7,7,7,0.68)_58%,rgba(7,7,7,0.2)_100%)] max-lg:bg-[linear-gradient(180deg,rgba(7,7,7,0.78),#070707_88%)]" />
      ...
      <div className="relative z-10 mx-auto grid min-h-[calc(100vh-7rem)] max-w-7xl items-center gap-12 lg:grid-cols-[0.92fr_1.08fr]">
        ...
        >
          ...
          <h1 className="font-display text-6xl uppercase leading-[0.92] text-text sm:text-7xl lg:text-8xl">
            I&apos;M
          ...
          <p className="mt-6 max-w-2xl text-base leading-8 text-muted sm:text-lg">
            I am a Java Full Stack Developer focused on building responsive web applications using
